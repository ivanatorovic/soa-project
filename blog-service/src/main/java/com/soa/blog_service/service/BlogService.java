...
public class BlogService {
    ...
    public BlogService(BlogRepository blogRepository, BlogLikeRepository blogLikeRepository, ObjectMapper objectMapper) {
        this.blogRepository = blogRepository;
        this.blogLikeRepository = blogLikeRepository;
        this.objectMapper = objectMapper;
    }

    public ResponseEntity<?> createBlog(String infoJson, List<MultipartFile> images, Long authorId, String authorUsername, HttpServletRequest request) {
        try {
    ...
    public ResponseEntity<?> likeBlog(String blogId, Long userId) {
        if (userId == null) {
    ...
    public ResponseEntity<?> unlikeBlog(String blogId, Long userId) {
        if (userId == null) {
            return ResponseEntity.badRequest().body(Map.of("message", "Morate proslediti userId"));
        }
        Blog blog = blogRepository.findById(blogId).orElse(null);
