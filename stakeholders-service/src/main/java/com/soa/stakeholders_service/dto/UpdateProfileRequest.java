...
public class UpdateProfileRequest {
    ...
    @Size(min = 1, max = 255, message = "Current password must be between 8 and 255 characters.")
    private String currentPassword;

    @Size(min = 1, max = 255, message = "New password must be between 8 and 255 characters.")
